<div class='md:px-5 md:last:pr-0 md:first:pl-0'>
    <div class="max-w-sm bg-white rounded-lg shadow-lg">
        ...
        <div class="p-6">
            ...
            <div class='flex'>
                <button href="#" data-modal-target="crud-modal" data-modal-toggle="crud-modal" type="button"
                    class="flex w-3/5 mr-1 items-center ease-in-out duration-300 justify-center px-3 py-3 text-sm font-medium text-center text-white rounded-lg bg-blue-600 hover:bg-blue-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 icon icon-tabler icon-tabler-edit" width="16"
                ...
                <button href="#" type="button"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 icon icon-tabler icon-tabler-trash" width="16"
                        height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M4 7l16 0" />
