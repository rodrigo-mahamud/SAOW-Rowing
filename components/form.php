        ...
        <form action="#" class="space-y-8">
            <div>
                ...
                <input type="email" id="email"
                    ...
                    placeholder="rodrigomahamud@gmail.com" required>
            </div>
            <div>
            ...
            <button type="submit"
                class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300">Enviar
                mensaje</button>
        </form>
    </div>
</div>